 ...
 *
 */
class ShelfGridLayoutManager : RecyclerView.LayoutManager() {
    ...
    private fun layoutAppearingViews(recycler: Recycler, referenceView: View, referencePosition: Int, extraCount: Int, offset: Int) {
        //Nothing to do...
    ...
    private fun layoutDisappearingView(disappearingChild: View) {
        ...
        val lp = disappearingChild.getLayoutParams() as LayoutParams
    ...
    companion object {
        private val TAG = ShelfGridLayoutManager::class.java.simpleName
